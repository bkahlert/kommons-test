...
**Please note that this project is now [part](https://github.com/bkahlert/kommons/tree/master/kommons-test) of
...
* **Gradle** `testImplementation("com.bkahlert.kommons:kommons-test:0.4.4") { because("JUnit defaults, testAll, ...") }`
* **Gradle** `implementation("com.bkahlert.kommons:kommons-test:0.4.4") { because("JUnit defaults, testAll, ...") }` *(for MPP projects)*
