 ...
 * ```
 */
internal fun Any.renderType(simplified: Boolean = true): String = buildString { this@renderType.renderTypeTo(this, simplified) }

/**
 * Renders the (simplified) type of this object to the specified [out].
 * @see renderType
 */
internal fun Any.renderTypeTo(out: StringBuilder, simplified: Boolean = true) {
    if (simplified) {
        when (this) {
            // specific types
